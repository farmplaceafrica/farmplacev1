...
const RegisterPage = () => {
			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
				<div>
					...
					<input
						...
						className={`w-full px-4 py-3 border-2 rounded-xl  outline-none  focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 ${
							errors.fullname
			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
				...
				<div>
					...
					<input
						...
						className={`w-full px-4 py-3 border-2  outline-none  rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 ${
							errors.location
								? "border-red-500 bg-red-50"
								: "border-gray-200 hover:border-gray-300"
						}`}
			...
			<div>
				...
				<div className='relative'>
					<input
						...
						className={`w-full px-4 py-3 border-2 outline-none rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 pr-12 ${
							errors.password
								? "border-red-500 bg-red-50"
								: "border-gray-200 hover:border-gray-300"
						}`}
			...
			<div>
				...
				<div className='relative'>
					<input
						...
						className={`w-full px-4 py-3 border-2 rounded-xl outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 pr-12 ${
	...
	// Updated RegisterPage component - Key changes in renderStep2()
	...
	const renderStep2 = () => (
		<div className='space-y-6'>
			...
			<div className='bg-white border-2 border-gray-200 rounded-xl p-6'>
				...
				{/* Updated ConnectWallet component with onConnect callback */}
				<ConnectWallet
						...
						<div className='flex items-center'>
							...
							<div>
								...
								<p className='text-xs text-green-600 mt-1 font-mono'>
									{formData.wallet.slice(0, 20)}...{formData.wallet.slice(-10)}
								</p>
							</div>
						</div>
					</div>
